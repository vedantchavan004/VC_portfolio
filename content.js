...
const content = {
  ...
  about: {
    body: {
      en: "I started in mechanical engineering and PLC cabinets in Pune, and ended up writing cost-volume networks for headlights in Lippstadt. The through-line is geometry: I like problems where a model has to agree with the physical world, and where being wrong is measurable in metres.\n\nMost of my work sits between research and shipping — reading the paper, building the dataset that the paper assumed existed, and then getting the thing small enough to run on the hardware that is actually in the car.",
      de: "Ich habe im Maschinenbau und an SPS-Schaltschränken in Pune angefangen und schreibe heute Cost-Volume-Netze für Scheinwerfer in Lippstadt. Der rote Faden ist Geometrie: Mich interessieren Probleme, bei denen ein Modell mit der physischen Welt übereinstimmen muss und bei denen ein Fehler in Metern messbar ist.\n\nDer Großteil meiner Arbeit liegt zwischen Forschung und Serie — das Paper lesen, den Datensatz bauen, den das Paper voraussetzt, und das Ergebnis so klein machen, dass es auf der Hardware läuft, die wirklich im Auto steckt."
    },
    education: [
