...
(function() {
  // Support multiple possible selectors so it works with existing HTML
  const btn = document.getElementById('download-cv-btn')
            || document.querySelector('[data-cv-btn]')
            || document.querySelector('.download-cv-btn');
  const menu = document.getElementById('cv-dropdown')
            || document.querySelector('[data-cv-menu]')
  ...
  // Close menu after selecting a CV link
  ...
  "en": {
    ...
    "about.stat.meng_field": "Mechatronics",
    "about.stat.btech_field": "Mechanical",
  ...
  "de": {
    ...
    "experience.bullet.01": "Mitwirkung am AHEAD‑Projekt (Adaptive Scheinwerfer für verbesserte Umgebungswahrnehmung im automatisierten Fahren).",
    "experience.bullet.02": "YOLOv8 für nächtliche Objekterkennung auf Stereo‑Eingaben feinabgestimmt; optimierte ONNX‑Modelle auf eingebetteten ADAS‑Plattformen bereitgestellt.",
    "experience.bullet.03": "Stereokameras kalibriert und Homographie für 2D‑zu‑3D‑Projektion genutzt; Triangulations‑Pipelines für Fahrzeugwahrnehmung entwickelt.",
    "experience.bullet.04": "mAP von YOLOv8 bei schlechten Lichtverhältnissen durch Stereo‑Fusion und domänenspezifisches Tuning von 60 % auf 90 % gesteigert.",
    "experience.bullet.05": "Echtzeit‑Inferenz‑Pipeline mit ONNX Runtime und Python‑APIs integriert.",
    "experience.bullet.06": "Leichtgewichtiges Stereo‑CNN mit Autoencoder und Cost‑Volume‑Fusion für Tiefenschätzung bei Nacht entwickelt.",
    "experience.bullet.07": "~3 % mittleren absoluten Fehler und ~95 % 3D‑Lokalisierungsgenauigkeit im Bereich 10–30 m erreicht.",
    "experience.bullet.08": "Über 9.000 synthetische Stereo‑Paare mit Unreal Engine 5 erzeugt; automatisierte Datenpipeline reduzierte manuelles Labeln um 90 %.",
    "experience.bullet.09": "Objekterkennung (YOLOv8) mit Disparitäts­schätzung für präzise 3D‑Bounding‑Boxes fusioniert.",
    "experience.bullet.10": "Validierung und Benchmarking der Algorithmen gemäß ADAS‑Sicherheitsprotokollen unterstützt.",
    "about.blurb": "Ich bin Vedant Sanjay Chavan – ein leidenschaftlicher AI‑Engineer mit Expertise in Machine Learning, Deep Learning, Computer Vision und Generativer KI. Mit praktischer Erfahrung bei HELLA GmbH & Co. und einem fundierten akademischen Hintergrund (M.Eng. Mechatronik, B.Tech. Maschinenbau) verbinde ich Kreativität mit technischer Exzellenz, um komplexe Daten in praxisnahe Lösungen zu verwandeln.",
    ...
    "experience.indpro.b1": "PLC‑Steuerlogik (ABB AC800M) für Automatisierungssysteme in der Zuckerindustrie entwickelt und in Betrieb genommen.",
    "experience.indpro.b2": "HMI‑Dashboards entworfen sowie Inbetriebnahme und Fehlersuche vor Ort in mehreren Anlagen unterstützt.",
    "projects.p1.title": "Benutzerdefiniertes YOLO for Robotisches Bin Picking",
    "projects.p1.info": "Entwickelt a custom YOLO model for detecting objects in bin picking tasks, achieving 95% Präzision in Orientierungserkennung.",
    "projects.p1.d1": "Entwickelt TensorFlow-based YOLO model for precise Objekterkennung & Orientierungsschätzung.",
    "projects.p1.d2": "Trained the model using synthetic (Blender) & real-world datasets, achieving 95% Präzision.",
    "projects.p1.d3": "Optimized the model to enhance AI performance under industriellen conditions, ensuring reliable Automatisierung.",
    "projects.p2.title": "Tiefe Stereo‑Vision for Nachtszenen im Straßenverkehr",
    "projects.p2.info": "Entworfen a CNN-based Tiefenschätzung model using PyTorch, achieving 90% Genauigkeit in schwachem Licht scenarios.",
    "projects.p2.d1": "Entworfen a CNN-based Tiefenschätzung model using PyTorch, for schwachem Licht scenarios.",
    "projects.p2.d2": "Generated synthetic training datasets using Unreal Engine 5, improving model generalization.",
    "projects.p2.d3": "Erreicht 90% Genauigkeit in Tiefenschätzung, outperforming conventional automotive AI methods",
    "projects.p3.title": "3D‑Rekonstruktion mit Gaussian Splatting",
    "projects.p3.info": "Monokulares Smartphone‑Video umgewandelt in eine dichte 3D‑Szene mithilfe von COLMAP‑Vorverarbeitung und Gaussian‑Splatting‑Rendering.",
    "projects.p3.d1": "Extracted camera poses and sparse point clouds using <strong>COLMAP</strong> from monocular input video.",
    "projects.p3.d2": "Used <strong>Gaussian Splatting</strong> to rendern fotorealistische 3D views with transparency and shading effects.",
    "projects.p3.d3": "Visualized and explored outputs in <strong>Open3D</strong>, and investigated mesh conversion workflows.",
    "projects.p3.d4": "Handled lighting, occlusion, and splat shaders for high-fidelity renderning of complex indoor scenes.",
    "projects.p4.title": "Object Instance segmentation with FastAPI and AWS",
    "projects.p4.info": "YOLOv11 instance segmentation deployed via FastAPI, containerized with Docker on AWS EC2/ECR, and automated using GitHub Actions CI/CD.",
    "projects.p4.d1": "Real-Time Object Detection & Segmentation: Uses YOLOv11 for accurate instance segmentation.",
    "projects.p4.d2": "FastAPI Backend: Serves the model predictions via REST API.",
    ...
    "projects.p4.d5": "Automated CI/CD Pipeline: Uses GitHub Actions for continuous deployment.",
    "projects.p5.title": "PaDiM-based Anomaly Detection",
    "projects.p5.info": "Erstellt a lightweight visual anomaly detection system using PaDiM and ONNX for industriellen defect detection.",
    "projects.p5.d1": "Extracted multi-level features from MobileNetV3 and computed Mahalanobis-based anomaly scores at pixel level.",
    "projects.p5.d2": "Exported the feature extractor to ONNX and performed inference using ONNX Runtime for cross-platform compatibility.",
    "projects.p5.d3": "Visualized anomalies with heatmaps and binary masks using images from the MVTec AD dataset.",
    "projects.p6.title": "U-Net for Biological Image Segmentation",
    "projects.p6.info": "Trained a U-Net model on fluorescence microscopy images to segment nuclei structures with high Genauigkeit.",
    "projects.p6.d1": "Parsed and preprocessed instance masks into binary labels using CLAHE and Gaussian blur.",
    "projects.p6.d2": "Erstellt a lightweight U-Net in PyTorch; trained for 100 epochs on nuclei segmentation dataset.",
    "projects.p6.d3": "Erreicht Dice score of <strong>0.89</strong> and IoU of <strong>0.82</strong> on the validation set.",
    "projects.p6.d4": "Visualized predicted masks and prepared inference-ready model using Colab.",
    "projects.p7.title": "Conversational AI Chatbot with RAG & LLM Fine-Tuning",
    "projects.p7.info": "Entwickelt a GPT-based conversational AI assistant, integrated FAISS vector search, and deployed using Docker & Hugging Face Spaces.",
    "projects.p8.title": "GaugeVision",
    "projects.p8.info": "The goal is to simplify gauge monitoring and tagging by using YOLOv11 pose model and QR detector.",
    "projects.p8.d1": "Trained a custom YOLOv11 pose model to detect keypoints on analog pressure gauges.",
    "projects.p8.d2": "Integrated OpenCV's QR code detector to read identification tags placed on or near gauges.",
    "projects.p8.d3": "Combined both outputs visually to show needle direction and QR data in one intuitive display.",
    "projects.p9.title": "Edge Detector GUI (Qt + OpenCV + C++)",
    "projects.p9.info": "Erstellt an interactive desktop app using Qt and OpenCV for visualizing Sobel and Canny edge detection with real-time threshold sliders.",
    "projects.p9.d1": "Integrated OpenCV with Qt to enable real-time image processing using Sobel and Canny filters.",
    "projects.p9.d2": "Added dynamic UI with sliders and dropdowns for live threshold tuning and filter selection.",
    "projects.p9.d3": "Entworfen clean modular C++ logic with CMake for cross-platform build compatibility.",
    "projects.p10.title": "BLIP-1 Optimization for Efficient Image Captioning",
    "projects.p10.info": "Optimized BLIP-1 image-captioning on CPU via dynamic quantization and pruning, achieving 1.42× speedup with no Genauigkeit loss.",
    "projects.p10.d1": "Baseline BLIP-1 CPU inference in 0.69 s for correct captions.",
    "projects.p10.d2": "Applied dynamic quantization to all Linear layers, reducing latency to 0.48 s.",
    "projects.p10.d3": "Combined 30% L1 pruning + quantization for a 1.40× speedup.",
    "projects.p10.d4": "Preserved caption quality (“a man and his dog”) across all variants.",
    "projects.p11.title": "Stereo Point Cloud Reconstruction",
    "projects.p11.info": "Erstellt a stereo vision pipeline for 3D point cloud reconstruction, achieving dense 3D models using SGBM and filtering.",
    "projects.p11.d1": "Entwickelt a robust stereo vision pipeline using OpenCV to compute disparity maps and reconstruct 3D point clouds from stereo images, improving Tiefenschätzung Genauigkeit.",
    "projects.p11.d2": "Optimized disparity computation by fine-tuning SGBM parameters and applying filtering techniques, reducing noise and enhancing 3D reconstruction quality.",
    "projects.p11.d3": "Generated and exported point clouds in PLY format, enabling seamless visualization and analysis in 3D modeling applications.",
    "projects.p12.title": "Defect Detection in Prints Using U-Net",
    "projects.p12.info": "Implementiert a U-Net model for defect detection, achieving 95% Präzision and reducing manual inspection time by 50%.",
    "projects.p12.d1": "Implementiert a U-Net-based model for defect detection, achieving 95% Präzision in quality assurance.",
    "projects.p12.d2": "Erstellt an AI pipeline processing 1000+ images per day, enhancing data throughput by 25%.",
    "projects.p12.d3": "Automated defect detection reporting, delivering real-time insights to quality control teams.",
    "projects.p13.title": "Predictive Maintenance Using XGBoost",
    "projects.p13.info": "Erstellt a vorausschauende Wartung model using XGBoost, achieving high Genauigkeit in failure prediction for industriellen systems.",
    "projects.p13.d1": "Entwickelt an end-to-end vorausschauende Wartung model leveraging XGBoost for industriellen failure prediction.",
    "projects.p13.d2": "Erreicht 98% Genauigkeit by tuning model hyperparameters and implementing advanced analytics.",
    "projects.p13.d3": "Automated reporting and insights generation, enhancing operational efficiency.",
    "projects.p14.title": "Reinforcement Learning for RRR Robot",
    "projects.p14.info": "Implementiert a RL model for Endeffektor Pfadplanung, optimizing robot arm Trajektorien in a 3D environment.",
    "projects.p14.d1": "Entwickelt and implemented RL-based trajectory optimization in MATLAB, improving end-effector Genauigkeit by 30% in reaching target positions.",
    "projects.p14.d2": "Trained the robot over 1,000 episodes using reward-based learning, reducing path deviation by 25% and ensuring efficient motion planning.",
    "projects.p14.d3": "Simulated and validated RL policies in MATLAB, achieving an 85% success rate in autonomously selecting optimal paths for task execution.",
    "projects.p15.title": "EKG‑Signalklassifikation with AI",
    "projects.p15.info": "Entwickelt a deep learning model for classifying ECG signals, achieving 99% Genauigkeit in detecting Herzanomalien.",
    "projects.p15.d1": "Entwickelt a deep learning model in Python for ECG signal classification, achieving 99% Genauigkeit in detecting abnormal heart rhythms.",
    "projects.p15.d2": "Preprocessed and segmented raw ECG data, improving model training efficiency by 40% through feature extraction and noise reduction.",
    "projects.p15.d3": "Optimized model inference speed, reducing prediction time by 30%, enabling real-time arrhythmia detection for potential clinical applications.",
  ...
  function updateDynamicLabels(dict) {
    ...
    // Download CV button label (if present)
    const dlBtn = document.getElementById('download-cv-btn') || document.querySelector('[data-cv-btn]') || document.querySelector('.download-cv-btn');
    if (dlBtn && dict["buttons.download_cv"]) {
      dlBtn.textContent = dict["buttons.download_cv"];
    }
  }
  ...
  function initLanguage() {
    ...
    // Also support generic language buttons/links
    document.querySelectorAll('[data-lang]').forEach(el => {
      el.addEventListener('click', (ev) => {
        ev.preventDefault();
        const targetLang = el.getAttribute('data-lang');
        if (targetLang) applyTranslations(targetLang);
      });
    });
    // Single toggle element support (switch EN <-> DE)
    const toggle = document.getElementById('lang-toggle') || document.querySelector('.lang-toggle');
    if (toggle) {
      toggle.addEventListener('click', (ev) => {
        ev.preventDefault();
        const current = localStorage.getItem('lang') || lang || 'en';
  ...
  if (contactForm && feedbackMessage) {
    contactForm.addEventListener('submit', (e) => {
      ...
      if (!isValid) {
        feedbackMessage.textContent = I18N[localStorage.getItem("lang") || "en"]["feedback.invalid"] || "Please fill all fields correctly.";
      ...
      if (typeof emailjs !== 'undefined') {
        emailjs.sendForm('service_fcwnhwo', 'template_tqz2zlq', contactForm)
          .then((result) => {
            feedbackMessage.textContent = I18N[localStorage.getItem("lang") || "en"]["feedback.success"] || "Message sent successfully!";
...
// === Contact form submission (Formspree / fetch) ===
document.addEventListener('DOMContentLoaded', () => {
  const form = document.getElementById('contact-form');
  const feedback = document.getElementById('contact-feedback');
  const submitBtn = form ? form.querySelector('.submit-btn') : null;

  // Replace with your Formspree form ID, e.g. "https://formspree.io/f/abcdwxyz"
  const FORM_ENDPOINT = window.CONTACT_FORM_ENDPOINT || "https://formspree.io/f/YOUR_FORM_ID";
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (feedback) {
            feedback.textContent = 'Could not send. Please try again in a moment.';
            feedback.style.display = 'block';
