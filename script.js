...
(function() {
  ...
  "en": {
    ...
    "about.stat.meng_field": "Technischen Hochschule Rosenheim, Germany",
    "about.stat.btech_field": "VIT, India",
    ...
    "projects.p1.info": "Developed a custom YOLO model for detecting objects in bin picking tasks, achieving 98% precision in orientation detection.",
    "projects.p1.d1": "Developed TensorFlow-based YOLO model for precise object detection &amp; orientation estimation.",
    "projects.p1.d2": "Trained the model using synthetic (Blender) &amp; real-world datasets, achieving 98% precision.",
    ...
    "projects.p2.info": "Designed a CNN-based depth estimation model using PyTorch, achieving 95% accuracy in low-light scenarios.",
    ...
    "projects.p2.d3": "Achieved 95% accuracy in depth estimation, outperforming conventional automotive AI methods",
  ...
  "de": {
    ...
    "experience.bullet.07": "Erreichung eines D1-all ~3 % und einer 3D-Lokalisierungsgenauigkeit von ~95 % im Bereich 30 m.",
    ...
    "about.stat.meng_field": "Technischen Hochschule Rosenheim, Deutschland",
    "about.stat.btech_field": "VIT, Indien",
